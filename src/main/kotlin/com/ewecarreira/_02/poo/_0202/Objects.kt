...
/* -----------------------------------------------------------------|
| A criação de objetos no Kotlin, tem grandes diferenças em relação |
| ao Java.                                                          |
|                                                                   |
| Pode-se criar objetos dentro de uma função, ou separadamente no   |
| mesmo arquivo, e o mesmo objeto também pode ser criado separamente|
| em outro arquivo.                                                 |
|                                                                   |
...
fun main() {
    ...
    /* -----------------------------------------------------------------|
    | Os atributos dos objetos são como qualquer outra variavel, caso os|
    | atributos estejam setados como "var", eles podem ser alterados.   |
    |----------------------------------------------------------------- */
    ...
    /* -----------------------------------------------------------------|
    | Há também a Object Declarations, que ao contrário do Object Type  |
    | (visto acima), é uma instrução, e não uma expressão.              |
    |----------------------------------------------------------------- */
