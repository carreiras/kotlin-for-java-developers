...
Para criar um construtor primário utiliza-se a palavara-chave "constructor", porém, esta palavra também pode
ser omitida, simplificando assim a sintaxe.

A palavra-chave "constructor" só é realmente necessária, se o construtor tiver uma notação, ou um modificador
de visibilidade. E dentro do construtor primário não pode haver nenhuma implementação ou código, porém, caso
seja necessário efetuar algo assim que a classe for inicializada, utiliza-se a palavra-chave "init".
